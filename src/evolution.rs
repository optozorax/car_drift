...
impl NnProcessor {
    ...
    pub fn reset(&mut self) {
        ...
        self.autoencoder_input.iter_mut().for_each(|x| *x = 0.);
        self.autoencoder_output.iter_mut().for_each(|x| *x = 0.);
...
pub fn evolution() {
    ...
    // save_runs(vec![evolve_simple_physics(&params_sim, &params_phys, &input, 100, 100, 10)], "simple_test_all_physics_7");
    save_runs(vec![evolve_by_cma_es_custom(&params_sim, &params_phys, &input, 30, 21, None, None)], "simple_test_all_physics_11");
